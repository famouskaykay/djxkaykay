...
CHANNEL = int(os.getenv('CHANNEL',-1001576388235))
API_ID = int(os.getenv("API_ID", "6"))
API_HASH = os.getenv("API_HASH", "eb06d4abfb49dc3eeb1aeb98ae0f581e")
BOT_USERNAME = os.getenv("BOT_USERNAME", "xkaykaybot")
ASSISTANT_NAME = os.getenv("ASSISTANT_NAME", "𝕜𝕒𝕪𝕜𝕒𝕪")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "KayAspirerProject")
UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "kayAspirerProject")
SOURCE_CODE = os.getenv("SOURCE_CODE", "github.com/famouskaykay/djxkaykay")
